...
!developmentChains.includes(network.name)
    ...
    : describe("BasicNft Tests", function () {
          ...
          beforeEach(async () => {
              ...
              basicNft = (await ethers.getContractAt("BasicNft", basicNftAddress)) as BasicNft;
          });
          ...
          describe("NFT Transfer", function () {
              ...
              it("updates balances after transfer", async function () {
                  ...
                  const balanceBefore1 = await basicNft.balanceOf(user1.address);

                  const balanceBefore2 = await basicNft.balanceOf(user2.address);
